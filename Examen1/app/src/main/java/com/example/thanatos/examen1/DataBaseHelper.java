...
public class DataBaseHelper extends SQLiteOpenHelper{
    ...
    public static final String BD_NOMBRE = "ExamenJl.db";
    ...
    public Cursor getCursor(){
        String columnas[]={COLUMNA_ID_CURSO,COLUMNA_NOMBRE_CURSO};
        Cursor c = this.getReadableDatabase().query(TABLA_CURSO,columnas,null,null,null,null,null);
        return c;
    }
        ...
        if(cursor.moveToFirst()){
            do {
                if(cursor.getInt(1) == usuario)
                {
                    ...
                    calificacion.setNombreCurso(cursor.getString(0),"");

                    calificacion.setIdUsuario(cursor.getInt(1));
                    calificacion.setNombreUsuario(cursor.getString(1),"");
