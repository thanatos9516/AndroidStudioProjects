...
//Si es primera vez descomentar
                ...
                db.ingresarEstudiante(new Estudiante(123,"Ama","123"));
                db.ingresarEstudiante(new Estudiante(124,"Juan","123"));
                db.ingresarEstudiante(new Estudiante(125,"Pedro","123"));

                db.ingresarCurso("Java");
                db.ingresarCurso("C++");
                db.ingresarCurso("C#");
